...
function PhotoUploader({ title, onPhotosChange, existingPhotos = [], userId }) {
    const [photos, setPhotos] = useState(["", "", "", ""]);
    const [isOpen, setIsOpen] = useState(false);
    console.log('photos123', photos)
                    ...
                    <div style={styles.dialog}>
                        ...
                        <div style={styles.scrollableContent}>
                            {photos.map((photo, index) => (
                                <div key={index} className="form-control" style={{ marginBottom: "10px" }}>
                        ...
                        {userId.startsWith("VC")|| userId.startsWith("VED-") && (<button onClick={addNewPhotoInput}>Add New</button>)}
