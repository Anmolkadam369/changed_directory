        ...
        <div className="user-form-container">
            ...
            {userId.startsWith("CUD-") && (
                ...
                <form className="user-form" onSubmit={handleSubmit}>
                    ...
                    <div className="user-form-group">
                        <i className="fa fa-calendar user-icon" aria-hidden="true"></i>
                        <input
                            className='input-profile'
                            type="text"
                            name="year"
                    ...
                    <div className="user-form-group">
                        <i className="fa fa-shield user-icon" aria-hidden="true"></i>
                        <input
                            className='input-profile'
                            type="text"
                            name="InsuranceName"
                ...
                <motion.form
                    ...
                    {step === 1 && (
                        ...
                        <>
                            {/* Company details */}
                            <h2
                                className="text-lg mt-3 font-bold text-center text-green-700"
                                as={motion.h2}
