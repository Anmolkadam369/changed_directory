...
//                                 type="button"
//                                 style={{ background: 'rgb(140 140 140)' }}
//                                 className="relative center-button text-white p-2 rounded-full shadow-lg hover:bg-black focus:outline-none mb-5 "
//                                 onClick={() => document.getElementById("hiddenFileInput").click()} // Programmatically trigger the file input
//                             >
//                                 <AddIcon />
//                             </button>
...
//                 {photos.length === 0 && (
//                     <div onClick={() => {
//                         props.setCurrentStep('04');
//                     }} className="bg-[#21A6E9] flex py-[5px] rounded-full pr-[6px] pl-[26px]">
//                         <button className="font-satoshi font-[400] text-[18px] leading-[33.6px] pr-[36px] text-[#FFFFFF]">Skip</button>
