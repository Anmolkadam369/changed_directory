...
function EditAccidentVehicle({ id, onUpdate }) {
    ...
    useEffect(() => {
        if (comingData) {
            setFormData(prevFormData => ({
                ...
                recoveryVan:comingData.recoveryVan || "",
                randomId: comingData.randomId || ""
            }));
            console.log("RANDOMID", comingData.crane)
            console.log("RANDOMI123123", comingData.recoveryVan)
    ...
    console.log('Recovery Van:',formData )
                        ...
                        {formData.choosenPlan === "advanced" && vendorData.length !== 0 && (
                            <div>
                                ...
                                {selectedOptionsArray.includes("workshop") && (
                                    ...
                                    <label className="form-field1">
                                        Recovery Van:
                                        <textarea disabled name="recoveryVan" >
                                            {formData.recoveryVan}
                                        </textarea>
                                    </label>)}
                            </div>
                        )}
