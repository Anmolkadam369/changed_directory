...
const MechanicDashboard = ({ getData }) => {
    ...
    const fetchAssignedCases = async () => {
        try {
            const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/assignedTasksMechanic/${userId}/${userId}`,{ headers: { Authorization: `Bearer ${token}` }});
    ...
    return (
        <div className="dashboard">
            <Helmet>
                <title>Mechanic Dashboard - Claimpro</title>
