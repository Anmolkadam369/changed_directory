...
function Footer() {
    return (
        <>
            <footer className=' bg-white flex gap-[70px] md:flex-row justify-center flex-col pt-[47px] md:px-[80px] px-[20px] md:pb-[70px] pb-[40px]'>
                <div className="max-w-[744px] w-full">
                    ...
                    <div className="flex justify-between md:flex-row flex-col md:gap-0 gap-[20px] pt-[40px]">
                        <div>
                            <h6 className="font-[700] font-satoshi text-[20px] mb-0 pb-[20px] leading-[24px] uppercase text-[#1B2E3F]">Quick Links</h6>
                        ...
                        <div>
                            <h6 className="font-[700] font-satoshi text-[20px] mb-0 pb-[20px] leading-[24px] uppercase text-[#1B2E3F]">Links</h6>
                            <div className="flex flex-col gap-[20px]">
                                <Link className='font-[400] font-satoshi text-[16px] leading-[20px] text-[#000000] no-underline' to="/">
                                    Scrap
                                </Link>
                        ...
                        <div>
                            <h6 className="font-[700] font-satoshi text-[20px] mb-0 pb-[20px] leading-[24px] uppercase text-[#1B2E3F]">COntact Us</h6>
                            <div className="flex flex-col gap-[20px]">
                ...
                <div className="max-w-[496px] w-full bg-[#21A6E9] rounded-[10px] py-[46px] md:px-[56px] px-[20px]">
                    ...
                    <div className="bg-[#21A6E9] border-[1px] border-[#FFFFFF] flex py-[5px] items-center justify-between rounded-full pr-[6px] pl-[26px] max-w-[180px] mx-auto w-full" style={{border:'1px solid white' }} >
                        <button className="font-satoshi font-[400] text-[18px] leading-[33.6px] pr-[20px] text-[#FFFFFF]">Join Now</button>
                        <img src={right} className='h-[40px] w-[40px]' alt="" />
                    </div>
                </div>
            </footer >
        </>
