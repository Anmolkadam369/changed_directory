      ...
      <div className="row mb-4">
        ...
        <div className="col-md-6">
          ...
          <ul className="list-group">
            ...
            <li className="list-group-item"><strong>Product Description:</strong>  This is a full description of the product with detailed specifications and information.</li>
          </ul>
        </div>
          ...
          <table className="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td>2024-10-01</td>
                <td>
                  <button className="me-3 btn btn-success">Accept</button>
                  <button className="me-3 btn btn-danger">Reject</button>
