...
const CraneRejectedOrder = ({ data }) => {
    ...
    const getFilteredData = (filter) => {
        ...
        if (filter === 'newest') {
            ...
            setTotalRejectedCase([...spareUseData]);
            ...
            setTotalRejectedCase(filteredData);
        }
    };
    ...
    useEffect(() => {
        ...
        if (totalRejectedCases.length > 0 && totalRejectedCases.length) {
            ...
            totalRejectedCases.forEach((item, index) => {
...
export default CraneRejectedOrder;