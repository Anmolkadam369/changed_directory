...
const NotAssignedVendorsHere = ({ aspect, title }) => {
    ...
    return (
        // <div className="chart">
        //     {/* <div style={{fontSize:"15px", fontWeight:"bold"}}>Vendor</div> */}
...
<p style={{fontSize:"10px", color:'green'}}>Not Assigned Vendors</p>
</div>
...
export default NotAssignedVendorsHere;
