...
const AssignedVehicleWorkshop = () => {
  ...
  useEffect(() => {
    ...
    if (GetDataOfUser && GetDataOfUser.vendorCode) {
      const fetchAssignedCases = async () => {
        ...
        try {
          const response = await axios.get(`http://localhost:3001/api/assignedTasksWorkshop/${GetDataOfUser.vendorCode}`);
  ...
  return (
    <div>
      <h3 className='titles'>Assigned Vehicles To Workshop</h3>
