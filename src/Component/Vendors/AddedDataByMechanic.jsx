...
function AddedDataByMechanic({ id, item, onUpdate }) {
    ...
    useEffect(() => {
        if (existingData) {
            ...
            console.log("Paidbycasessss", formData.paidByCash)
            console.log("existingData", existingData.paidByCash)
        }
    }, [existingData]);
    console.log("FORM_DD_DA", formData)
        ...
        <div>
            <form className='Customer-master-form'>
                <Helmet>
                    ...
                    <link rel='canonical' href={`https://claimpro.in/AddedDataByMechanic`} />
                </Helmet>
...
export default AddedDataByMechanic;
